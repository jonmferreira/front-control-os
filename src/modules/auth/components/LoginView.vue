          ...
          <ul class="mt-6 grid gap-4 text-sm text-slate-100 lg:grid-cols-2">
            ...
            <li class="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/5 p-3">
              ...
              <div>
                ...
                <p class="text-xs text-slate-200">Sessão por perfil (técnico, analista, administrador) com refresh curto.</p>
              </div>
            </li>
            <li class="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/5 p-3">
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                  ...
                  >
                    <span class="flex items-center gap-2">
                      ...
                      <Tag :value="option.roleLabel" severity="secondary" class="text-xs uppercase" />
                    </span>
                  </Button>
                </div>
              </div>
